...
class Metadata(object):
  ...
  def previous_execution(
    ...
    Raises:
      RuntimeError: when pipeline run context not found.
    """
    absl.logging.debug(
    ...
    if context is None:
      raise RuntimeError('Pipeline context not available for %s' %
                         pipeline_info)
  ...
  def get_pipeline_context(
    ...
    Args:
      pipeline_info: component information for the current component run.
